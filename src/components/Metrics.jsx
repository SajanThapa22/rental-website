...
const Metrics = () => {
  return (
    <div className="w-full py-p-24px px-p-26px md:px-16 lg:px-20 mt-mt-50 grid grid-rows-[auto,1fr,1fr,1fr] md:grid-cols-3 md:grid-rows-1 lg:grid-cols-4 gap-6 items-center justify-center">
